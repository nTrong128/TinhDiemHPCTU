...
function CreateNewRow() {
    ...
    $("<div class='row-hp last columns is-mobile'><div class='column is-5'><label class='label'>Tên học phần:</label><input type='text' name=' id=' class='input diemHP is-primary' placeholder='Nhập tên môn học'></div><div class='column is-3'><label class='label'>Điểm HP:</label><select name='' placeholder='Điểm HP' class='input diemHP is-primary' id='diemHP" + soHang.toString() + "'><option value='A'>A</option><option value='B+'>B+</option><option value='B'>B</option><option value='C+'>C+</option><option value='C'>C</option><option value='D+'>D+</option><option value='D'>D</option><option value='F'>F</option></select></div > <div class='column is-3'><label class='label'>Số tín chỉ HP:</label><select name='' id='soTC" + soHang.toString() + "' placeholder='Số TC' class='input soTC is-primary'><option value='1'>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option></select></div></div > " ).insertBefore( $( ".block" ) );
